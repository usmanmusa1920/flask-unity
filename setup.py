...
setup(
  ...
  install_requires=["click==8.1.3", "Flask==2.2.2", "Flask-Admin==1.6.0", "Flask-SQLAlchemy==3.0.2", "Flask-WTF==1.0.1", "Flask-Login==0.6.2", "greenlet==2.0.1", "importlib-metadata==6.0.0", "itsdangerous==2.1.2", "Jinja2==3.1.2", "MarkupSafe==2.1.1", "SQLAlchemy==1.4.45", "Werkzeug==2.2.2", "WTForms==3.0.1", "zipp==3.11.0"]
